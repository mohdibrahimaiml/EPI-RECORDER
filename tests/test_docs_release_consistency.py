...
CURRENT_PUBLIC_DOCS = [
    ...
    REPO_ROOT / "docs" / "EPI_MASTER_DOCUMENTATION.md",
...
def test_current_public_docs_point_to_runtime_release():
    ...
    assert expected in _read(REPO_ROOT / "docs" / "EPI_MASTER_DOCUMENTATION.md")
...
def test_current_flagship_doc_has_no_mojibake():
    text = _read(REPO_ROOT / "docs" / "EPI_MASTER_DOCUMENTATION.md")
    mojibake_markers = (
        "\u00e2\u20ac\u0153",
        "\u00e2\u20ac",
        "\u00e2\u20ac\u2122",
