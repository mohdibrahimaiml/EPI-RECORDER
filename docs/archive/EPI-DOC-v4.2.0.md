...
Release line observed in source: `v4.4.0`
...
## 2. What v4.4.0 adds over v4.0.3

`v4.4.0` is a security and ecosystem compatibility release. It hardens the trust chain and ensures the toolchain works across modern Python environments. The key improvements are:
