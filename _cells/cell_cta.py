...
display(HTML(
    ...
    '<h1 style="color: white; margin: 0; font-size: 42px;">The Evidence Layer for Every AI Agent</h1>'
    ...
    '</div>'
    '<p style="font-size: 20px; margin: 25px 0;">EU AI Act (Aug 2026): Up to 7% of global revenue for non-compliance.</p>'
    '<p style="font-size: 20px; margin: 5px 0;">Every enterprise deploying AI agents needs this. Today.</p>'
    '<p style="font-size: 18px; margin: 25px 0 0 0; opacity: 0.8;">mohdibrahim@epilabs.org | epilabs.org</p>'
    '</div>'
))
